...
# Pre-defined configs
##
from wheel_leg_humanoid_lab.assets import WHEEL_LEG_HUMANOID_DRIVING_MODE_FIXED_HIP_CFG # isort: skip
from .rough_env_cfg import WheelLegHumanoidDrivingRoughEnvCfg


@configclass
class WheelLegHumanoidDrivingFixedHipRoughEnvCfg(WheelLegHumanoidDrivingRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ------------------------------Sence------------------------------
        self.scene.robot = WHEEL_LEG_HUMANOID_DRIVING_MODE_FIXED_HIP_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        if self.__class__.__name__ == "WheelLegHumanoidDrivingFixedHipRoughEnvCfg":
